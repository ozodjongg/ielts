...
export default function LoginPage() {
  ...
  return <div className="login-wrap"><div className="login-card">
    ...
    <h1 className="title">Kirish</h1><p className="subtitle">Student learning and assessment portal</p>
    <form className="stack section" onSubmit={submit}>
    ...
    <div className="divider" /><p className="muted" style={{ fontSize: 12 }}>Student login parol va server-side sessiya/rol tekshiruvlari bilan himoyalanadi.</p>
  </div></div>;
}
